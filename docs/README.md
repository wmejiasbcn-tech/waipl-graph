...
Fuente de las fichas: tabla oficial del Soberano (septiembre 2026), 45 nodos, texto exacto.

El núcleo de esa tabla (William–Áurea) es el 11+1 del deck de principios. 45 no sustituye a 11+1. Emily no es núcleo: es la sinapsis entre Carla y Graphy.
